...
#define kConfigurationSIP @"SIP"
#define kConfigurationSIPValue @"value"
#define kConfigurationHostsFile @"hostsfile"
#define kConfigurationHostsFileCount @"count"
#define kConfigurationHostsFileStatus @"status"
...
#define kTimeMachineSkipSystemFiles @"skipsystemfiles"
#define kTimeMachineMobileBackups @"mobilebackups"
#define kTimeMachineAutoBackup @"autobackup"
#define kTimeMachineBackedupVolumes @"backedupvolumes"
#define kTimeMachineVolume @"volume"
#define kTimeMachineVolumeName @"name"
#define kTimeMachineVolumeSize @"size"
#define kTimeMachineVolumeSizeRequired @"sizerequired"
#define kTimeMachineDestinations @"destinations"
#define kTimeMachineDestination @"destination"
#define kTimeMachineDestinationName @"name"
#define kTimeMachineDestinationType @"type"
#define kTimeMachineDestinationLastUsed @"lastused"
#define kTimeMachineDestinationSize @"size"
#define kTimeMachineDestinationBackupCount @"backupcount"
